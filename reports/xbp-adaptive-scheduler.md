...
kernel 793, client 001, single application server `examplesrv_A4H_00`, 5 batch work
...
| `TH_SERVER_LIST` | out `LIST[7]`, `LIST_IPV6[14]` | Legal `TARGET_SERVER` values. Live: one server, `examplesrv_A4H_00`. Cache; it changes on instance start/stop. |
...
Lifecycle (VSP_SCHED_PROBE1/2, report RSWAITSEC, param WAITTIME, TARGET_SERVER examplesrv_A4H_00):
